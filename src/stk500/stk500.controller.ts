...
export class Stk500Controller {
  ...
  runPhysicalImpactScript(
    ...
    return this.stk500Service.runPhysicalImpactScript(params.buttons, params.resistor);
  }

  @Get('button/:buttons')
  buttonAction(
    @Param() params: ButtonsDTO,
  ) {
  ...
  resistorAction(
    ...
    const command: string = this.stk500Service.valueResistorToCommand(params.resistor);
